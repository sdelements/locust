...
class HttpLocust(Locust):
    ...
    client_class = HttpSession
    """
    Factory function for creating the client object that will run locust tasks.
    The factory should accept a base_url kwarg.
    """
    ...
    def __init__(self, runner=None):
        ...
        self.client = self.client_class(base_url=self.host, runner=runner)
